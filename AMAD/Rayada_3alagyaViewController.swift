//
//  Rayada_3alagyaViewController.swift
//  AMAD
//
//  Created by mohamed albohy on 3/30/20.
//  Copyright © 2020 AMAD. All rights reserved.
//

import UIKit

class Rayada_3alagyaViewController: UIViewController,UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
